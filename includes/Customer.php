  ...
  $email   = mysqli_real_escape_string($this->db, $_POST['email']);
  $subject = mysqli_real_escape_string($this->db, $_POST['subject']);
  $message = mysqli_real_escape_string($this->db, $_POST['message']);
  if (empty($email)||empty($subject)||empty($message)) {
    return $msg="<span class='error'>Empty Fields. Please enter every field</span>";
  }
  if (!filter_var($email,FILTER_VALIDATE_EMAIL)) {
               return $msg="<span class='error'>Invalid email .Please enter valid email.</span>";
  ...
  if (!empty($email)&&!empty($subject)&&!empty($message)) {
               //send the email to 
                  ...
                  $mail->setFrom($email, 'Customer-'.$email);
                  ...
                  // echo 'Message has been sent';
                  return $msg="<span class='success'>Message sent! Thank you !</span>";
